...
def create_output_directory(base_url):
    """
    Creates an output directory named after the main domain in the same directory as the script.
    ...
    # Define the directory path in the same directory as the script
